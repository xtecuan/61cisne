...
public class FinderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<LibroDTO> respuestaLibro = new ArrayList<LibroDTO>(0);
        AlumnoDTO dto = new AlumnoDTO();
        LibroDTO dtoLibro = new LibroDTO();
        ...
        if (findVal) {
            ...
            if (find.equals(NOMBRES) && nombresVal) {
                ...
                respuestaLibro   =  LibrosFacade.findLikeNames(nombres,dataSource);
            }
          ...
          /*  if (respuesta.isEmpty()) {
             ...
             if (respuestaLibro.isEmpty()) {
                ...
                session.setAttribute(RESPUESTA, respuestaLibro);
            }
