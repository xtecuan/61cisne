                ...
                <tr>
                    ...
                    <td>
                        ...
                        <c:url value="/app/librosEditar.jsp" var="editAl">
                            ...
                            <c:param name="codigo" value="${libro.codigo}"/>
                            <c:param name="nombre" value="${libro.nombre}"/>
                            <c:param name="autor" value="${libro.autor}"/>
                            <c:param name="isbn" value="${libro.isbn}"/>
                            <c:param name="fechaimpresion" value="${libro.fechaimpresion}"/>
