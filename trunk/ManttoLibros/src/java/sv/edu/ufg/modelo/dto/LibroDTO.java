...
public class LibroDTO {
    ...
    private static final String SELECT_BY_ID = "select * from libros where id_libro=?";
    ...
    private static final String INSERT = "insert into libros(codigo,nombre,autor,ISBN,fechaimpresion,estado) "
            + "values(?,?,?,?,?,?)";
    private static final String DELETE = "delete from libros where id_libro=?";
    private static final String UPDATE_BASE = "UPDATE libros SET ${0} WHERE id_libro = ?";
    //Variable static
